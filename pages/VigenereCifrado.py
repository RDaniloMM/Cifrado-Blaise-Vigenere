...
from lib.algoritmo_blaise_vigenere import cifrar, ALFABETOS

# Página 1
class Page(BasePage):
    title = "Cifrado por el Algoritmo de Blaise Vigenère"
    description = "Cifra un texto utilizando el algoritmo de Blaise Vigenère."
